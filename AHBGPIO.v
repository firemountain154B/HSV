...
module AHBGPIO(
  ...
  input wire HSEL,
  input wire HREADY,
  input wire [16:0] GPIOIN,// 17bit for parity
	
	//Output
  output wire HREADYOUT,
  output wire [31:0] HRDATA,
  output wire [16:0] GPIOOUT,// 17bit for parity
...
//Parity Check
  ...
  assign  PARITYERR = (GPIOIN[16] == Result)? 0: 1;
...
wire check;
assign check = (last_HADDR[7:0] == gpio_dir_addr) & last_HSEL & last_HWRITE & last_HTRANS[1];
  ...
  assign GPIOOUT[15:0] = gpio_dataout;
